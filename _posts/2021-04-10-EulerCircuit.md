...
<span style="color:red"> test </span> <span style="color:brown"> test </span>

![](https://user-images.githubusercontent.com/81361400/114203456-27afb180-9993-11eb-8930-7301c7fb0095.png)

처음에는 1번 정점에서 시작해서 1번 정점으로 돌라오는 경로인 <span style="color:red">**1 - 2 - 3 - 4 - 5 - 6 - 1**</span>을 찾습니다.
...
마찬가지로 5번 정점에서 시작해서 5번 정점으로 돌아오는 경로인 <span style="color:red">**5 - 10 - 11 - 5**</span>을 찾고 이전의 경로에 삽입합니다. 경로는 <span style="color:brown">**1 - 2 - 3 - 4 - 5**</span> <span style="color:red">**- 10 - 11 - 5**</span> <span style="color:brown">**- 6 - 2 - 4 - 6 - 1**</span>이 됩니다.
